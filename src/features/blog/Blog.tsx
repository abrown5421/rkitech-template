...
const Blog: React.FC<BlogProps> = () => {
  ...
  const handlePostClick = (postId: string) => {
    const blogPostPage = application.pages.find(
      (p) => p.pageName === "BlogPost",
    );
        ...
        >
          <div className="flex flex-1 justify-center">
            ...
            >
              <Icon
                iconName="SkipBack"
                color={currentPage === 1 ? "gray" : "amber"}
                intensity={currentPage === 1 ? 300 : 500}
                size={15}
              />
            </Button>
            ...
            >
              <Icon
                ...
                color={currentPage === totalPages ? "gray" : "amber"}
                intensity={currentPage === totalPages ? 300 : 500}
                size={15}
              />
            </Button>
          </div>
