export const blogPostTemplate = (componentName: string, folderName: string): string => 
...
const ${componentName}: React.FC = () => {
  ...
  return (
    <Container tailwindClasses={\`flex-col w-full md:w-4/5 mx-auto h-full min-h-[calc(100vh-50px)] p-5 text-\${themeBlack}\`}>
      ...
      <Container tailwindClasses="flex-row items-center justify-between">
        ...
        <Text text={formatDate(post.postDate)} tailwindClasses="text-sm text-gray-500" />
      </Container>
